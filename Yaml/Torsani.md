...
- **Ultimo commit:** That's it(vedere la pagina del repo)[^1]  
- **Tecnologie:** *YAML*, *XML*, *XSD*, *Git*  
- **File chiave:** `dati/rubrica.yml`, `xml/rubrica.xml`, `schema/rubrica.xsd`  
- **Test:** test unitari inclusi; pipeline CI configurata per lint e test[^2]
...
- Integrare la validazione XSD nella pipeline CI per prevenire regressioni[^3].  
